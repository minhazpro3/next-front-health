    ...
    <div className="  ">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5 items-center">
        ...
        <div>
          ...
          <button className=" hidden md:block mt-10 md:mt-16 text-base py-4 text-white md:flex items-center justify-around w-[246px] bg-[#264373] rounded-lg">
            Get started{" "}
            <span className="text-base">
              <HiOutlineArrowNarrowRight />
            </span>
          </button>
          <button className=" block md:hidden mt-10 md:mt-16 text-xs py-3 text-white flex items-center justify-around w-[176px] bg-[#264373] rounded-lg">
            Get started{" "}
